...
let AuthenticationService = class AuthenticationService {
  ...
  async genTokens(user) {
    const accessToken = await this.jwtService.signAsync({
      ...
      expiresIn: this.configService.get("AUTH_ACCESS_TOKEN_EXPIRES")
    });
    const refreshToken = await this.jwtService.signAsync({
      id: user.id
    }, {
      secret: this.configService.get("AUTH_SECRET") + user.password,
      expiresIn: this.configService.get("AUTH_REFRESH_TOKEN_EXPIRES")
    });
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("b8ed8f7607f4c8efee37")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.4b6c3b2078e838faaa23.hot-update.js.map