...
let BillResolver = class BillResolver {
  ...
  async getBillsPerMonth(user, args) {
    const [bills, count] = await this.billService.findAndCount(user.id);
    return (0, graphql_relay_1.connectionFromArray)(bills, args);
  }
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("e0c8181d019f35bf539f")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.e3acf5fe93726f88612b.hot-update.js.map