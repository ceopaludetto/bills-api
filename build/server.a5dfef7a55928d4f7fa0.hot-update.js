...
let BillResolver = class BillResolver {
  ...
  async getBillsPerMonth(user, args) {
    const [bills, count] = await this.billService.findAndCount(user.id, args);
    return (0, pagination_1.Paginate)(bills, count, args);
  }
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("ecb0c54a2a7aa5846c9a")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.a5dfef7a55928d4f7fa0.hot-update.js.map