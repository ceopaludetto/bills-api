...
let AuthenticationResolver = class AuthenticationResolver {
  ...
  async checkToken({
    ...
    if (!(req !== null && req !== void 0 && (_req$headers = req.headers) !== null && _req$headers !== void 0 && _req$headers.authorization)) throw new common_1.UnauthorizedException("token-not-found");
    return this.authenticationService.checkToken(req.headers.authorization);
  }
...
__decorate([(0, common_1.UseGuards)(authentication_guard_1.GqlAuthenticationGuard), (0, graphql_1.Mutation)(() => Boolean), __param(0, (0, graphql_1.Context)()), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], AuthenticationResolver.prototype, "checkToken", null);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("bcde1346be479d18557a")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.7746facd9cfcc01cb39b.hot-update.js.map