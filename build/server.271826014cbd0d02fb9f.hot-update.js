...
let BillResolver = class BillResolver {
  ...
  async getBills(user, args) {
    return this.billService.find(user.id, args);
  }
...
__decorate([(0, common_1.UseGuards)(authentication_1.GqlAuthenticationGuard), (0, graphql_1.Query)(() => [models_1.Bill]), __param(0, (0, authentication_1.CurrentUser)()), __param(1, (0, graphql_1.Args)({
  nullable: true
})), __metadata("design:type", Function), __metadata("design:paramtypes", [typeof (_a = typeof models_1.User !== "undefined" && models_1.User) === "function" ? _a : Object, typeof (_b = typeof bill_dto_1.BillGetArgs !== "undefined" && bill_dto_1.BillGetArgs) === "function" ? _b : Object]), __metadata("design:returntype", Promise)], BillResolver.prototype, "getBills", null);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("86be78d9c441ca31ab06")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.271826014cbd0d02fb9f.hot-update.js.map