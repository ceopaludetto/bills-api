    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.name === "TokenExpiredError") {
          ...
          if (!userID) super.canActivate(context);
          const user = await this.userService.findByID(userID);
          if (!user) super.canActivate(context);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("fe55b3aaca7ac9595896")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.16196d8504dec9b03d1f.hot-update.js.map