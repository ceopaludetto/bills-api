...
function PaginationArgs() {
  return (target, key, descriptor) => {
    let PaginationArgsType = class PaginationArgsType {
      constructor() {
        _defineProperty(this, "page", void 0);
    ...
    __decorate([(0, graphql_1.Field)(), __metadata("design:type", Number)], PaginationArgsType.prototype, "page", void 0);

    __decorate([(0, graphql_1.Field)(), __metadata("design:type", Number)], PaginationArgsType.prototype, "limit", void 0);

    PaginationArgsType = __decorate([(0, graphql_1.ArgsType)("PaginationArgs")], PaginationArgsType);
    return (0, graphql_1.Args)(() => PaginationArgsType)(target, key, descriptor);
  };
}
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("0f8ecd015877ecc71ff3")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.064150d4565010e627bb.hot-update.js.map