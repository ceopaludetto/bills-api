...
let BillService = class BillService {
  ...
  async balance(userID, {
    ...
    const res = await queryBuilder.select('sum("bill"."value")').where({
      user: userID,
      createdAt: {
        $gte: (0, date_1.day)(date).startOf("month").toDate(),
        $lte: (0, date_1.day)(date).endOf("month").toDate()
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("095dfbdef0d5e106122c")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.0c6ed6d4fa9b764f955b.hot-update.js.map