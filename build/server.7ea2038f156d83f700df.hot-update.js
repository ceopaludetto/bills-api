...
function PaginationArgs() {
  return (target, key, descriptor) => {
    ...
    PaginationArgs = __decorate([(0, graphql_1.ArgsType)("PaginationArgs")], PaginationArgs);
    return (0, graphql_1.Args)(() => PaginationArgs)(target, key, descriptor);
  };
}
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("064150d4565010e627bb")
/******/ 	})();
/******/ 	
/******/ }
;
//# sourceMappingURL=server.7ea2038f156d83f700df.hot-update.js.map